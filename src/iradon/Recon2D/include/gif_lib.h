...
typedef struct GifFileType {
    short int SWidth, SHeight,			       /* Screen dimensions. */
...
int EGifPutScreenDesc(GifFileType *GifFile,
	short int GifWidth, short int GifHeight, short int GifColorRes, short int GifBackGround,
	short int GifBitsPerPixel, GifColorType *GifColorMap);
int EGifPutImageDesc(GifFileType *GifFile,
	short int GifLeft, short int GifTop, short int Width, short int GifHeight, short int GifInterlace,
	short int GifBitsPerPixel, GifColorType *GifColorMap);
