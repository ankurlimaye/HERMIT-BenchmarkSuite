...
int wc_HmacSizeByType(int type) {
  ...
  switch (type) {
#ifndef NO_MD5
    case WC_MD5:ret = WC_MD5_DIGEST_SIZE;
      break;
#endif /* !NO_MD5 */

#ifndef NO_SHA
    case WC_SHA:ret = WC_SHA_DIGEST_SIZE;
      break;
#endif /* !NO_SHA */
...
#ifndef NO_SHA256
    case WC_SHA256:ret = WC_SHA256_DIGEST_SIZE;
      break;
#endif /* !NO_SHA256 */
...
#ifndef NO_SHA256
    case WC_SHA256:ret = wc_InitSha256(&hmac->hash.sha256);
      break;
#endif /* !NO_SHA256 */
...
#endif /* WOLFSSL_SHA224 */
#ifndef NO_SHA256
    case WC_SHA256:hmac_block_size = WC_SHA256_BLOCK_SIZE;
...
#ifndef NO_SHA256
    case WC_SHA256:ret = wc_Sha256Update(&hmac->hash.sha256, msg, length);
      break;
#endif /* !NO_SHA256 */
...
#endif /* WOLFSSL_SHA224 */
#ifndef NO_SHA256
    case WC_SHA256:ret = wc_Sha256Final(&hmac->hash.sha256, (byte *) hmac->innerHash);
      if (ret != 0)
        break;
...
#endif /* WOLFSSL_SHA224 */
#ifndef NO_SHA256
    case WC_SHA256:wc_Sha256Free(&hmac->hash.sha256);
      break;
#endif /* !NO_SHA256 */
